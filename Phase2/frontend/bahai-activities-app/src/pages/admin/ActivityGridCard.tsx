...
const ActivityGridCard = ({ activity, onEdit, onDelete }: Props) => {
    ...
    return (
        <div className="bg-white p-4 rounded-2xl shadow-lg border border-gray-100 hover:shadow-2xl transition-shadow duration-300 mb-2 mt-2">
            ...
            <div className="flex justify-between items-start pb-2">
                ...
                <div className="text-xs font-semibold text-gray-600 text-right space-y-1 pl-4">
            ...
            {/* Anfitrión */}
            <div className="border-t pt-2 w-full text-left pb-2">
